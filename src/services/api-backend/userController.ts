...
/** dayAttendance GET /api/user/attendance */
export async function dayAttendanceUsingGET(options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean>('/api/user/attendance', {
    method: 'GET',
    ...(options || {}),
  });
}
...
/** updateMyVoucher GET /api/user/update/voucher */
export async function updateMyVoucherUsingGET(options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean>('/api/user/update/voucher', {
    method: 'GET',
    ...(options || {}),
  });
}
